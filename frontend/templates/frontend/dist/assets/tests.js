...
define('ticket-system/tests/controllers/login.jshint.lint-test', [], function () {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/login.js should pass jshint.\ncontrollers/login.js: line 10, col 34, Missing semicolon.\ncontrollers/login.js: line 28, col 23, Missing semicolon.\n\n2 errors');
  });
});
...
define('ticket-system/tests/services/auth-service.jshint.lint-test', [], function () {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/auth-service.js should pass jshint.\nservices/auth-service.js: line 15, col 42, Missing semicolon.\nservices/auth-service.js: line 18, col 38, Missing semicolon.\nservices/auth-service.js: line 26, col 60, Missing semicolon.\nservices/auth-service.js: line 29, col 43, Missing semicolon.\nservices/auth-service.js: line 35, col 88, Missing semicolon.\nservices/auth-service.js: line 7, col 20, \'Promise\' is not defined.\nservices/auth-service.js: line 8, col 17, \'$\' is not defined.\n\n7 errors');
  });
});
