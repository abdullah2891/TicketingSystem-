...
return ['application',this.get('adapter',preferredKey).get('defaultSerializer'),'-default'];};ContainerInstanceCache.prototype._findInstance = function _findInstance(namespace,fallbacks){var cache=this._namespaces[namespace];for(var i=0,length=fallbacks.length;i < length;i++) {var fallback=fallbacks[i];if(cache[fallback]){return cache[fallback];}var lookupKey=namespace + ':' + fallback;var instance=this._instanceFor(lookupKey);if(instance){cache[fallback] = instance;return instance;}}};ContainerInstanceCache.prototype._instanceFor = function _instanceFor(key){return this._owner.lookup(key);};ContainerInstanceCache.prototype.destroyCache = function destroyCache(cache){var cacheEntries=Object.keys(cache);for(var i=0,length=cacheEntries.length;i < length;i++) {var cacheKey=cacheEntries[i];var cacheEntry=cache[cacheKey];if(cacheEntry){cacheEntry.destroy();}}};ContainerInstanceCache.prototype.destroy = function destroy(){this.isDestroying = true;this.destroyCache(this._namespaces.adapter);this.destroyCache(this._namespaces.serializer);this.isDestroyed = true;};ContainerInstanceCache.prototype.toString = function toString(){return 'ContainerInstanceCache';};return ContainerInstanceCache;})(); /**
  @module ember-data
*/var badIdFormatAssertion='`id` passed to `findRecord()` has to be non-empty string or number';var Backburner=Ember._Backburner;var ENV=Ember.ENV; //Get the materialized model from the internalModel/promise that returns
...
define('ember-simple-auth/authenticators/devise', ['exports', 'ember-simple-auth/authenticators/base', 'fetch'], function (exports, _emberSimpleAuthAuthenticatorsBase, _fetch) {
  'use strict';
...
define('ember-simple-auth/authenticators/oauth2-implicit-grant', ['exports', 'ember-simple-auth/authenticators/base'], function (exports, _emberSimpleAuthAuthenticatorsBase) {
  'use strict';
...
define('ember-simple-auth/authenticators/oauth2-password-grant', ['exports', 'ember-simple-auth/authenticators/base', 'fetch'], function (exports, _emberSimpleAuthAuthenticatorsBase, _fetch) {
  'use strict';
...
define('ember-simple-auth/authenticators/test', ['exports', 'ember-simple-auth/authenticators/base'], function (exports, _emberSimpleAuthAuthenticatorsBase) {
  'use strict';
...
define('ember-simple-auth/authenticators/torii', ['exports', 'ember-simple-auth/authenticators/base'], function (exports, _emberSimpleAuthAuthenticatorsBase) {
  'use strict';
...
define('ember-simple-auth/authorizers/devise', ['exports', 'ember-simple-auth/authorizers/base'], function (exports, _emberSimpleAuthAuthorizersBase) {
  'use strict';
...
define('ember-simple-auth/authorizers/oauth2-bearer', ['exports', 'ember-simple-auth/authorizers/base'], function (exports, _emberSimpleAuthAuthorizersBase) {
  'use strict';
...
define("ember-simple-auth/mixins/application-route-mixin", ["exports", "ember-simple-auth/configuration"], function (exports, _emberSimpleAuthConfiguration) {
  "use strict";
...
define('ember-simple-auth/mixins/authenticated-route-mixin', ['exports', 'ember-simple-auth/configuration'], function (exports, _emberSimpleAuthConfiguration) {
  'use strict';
...
define('ember-simple-auth/mixins/unauthenticated-route-mixin', ['exports', 'ember-simple-auth/configuration'], function (exports, _emberSimpleAuthConfiguration) {
  'use strict';
...
define('ember-simple-auth/session-stores/adaptive', ['exports', 'ember-simple-auth/session-stores/base', 'ember-simple-auth/session-stores/local-storage', 'ember-simple-auth/session-stores/cookie'], function (exports, _emberSimpleAuthSessionStoresBase, _emberSimpleAuthSessionStoresLocalStorage, _emberSimpleAuthSessionStoresCookie) {
  'use strict';
    ...
    */
    ...
    init: function init() {
      ...
      if (this.get('_isLocalStorageAvailable')) {
        ...
        store = this._createStore(_emberSimpleAuthSessionStoresCookie['default'], _options);
...
define('ember-simple-auth/session-stores/cookie', ['exports', 'ember-simple-auth/session-stores/base', 'ember-simple-auth/utils/objects-are-equal'], function (exports, _emberSimpleAuthSessionStoresBase, _emberSimpleAuthUtilsObjectsAreEqual) {
  'use strict';
...
define('ember-simple-auth/session-stores/ephemeral', ['exports', 'ember-simple-auth/session-stores/base'], function (exports, _emberSimpleAuthSessionStoresBase) {
  'use strict';
...
define('ember-simple-auth/session-stores/local-storage', ['exports', 'ember-simple-auth/session-stores/base', 'ember-simple-auth/utils/objects-are-equal'], function (exports, _emberSimpleAuthSessionStoresBase, _emberSimpleAuthUtilsObjectsAreEqual) {
  'use strict';
